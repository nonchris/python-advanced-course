...
\noindent \tb{Read-Write Lock} \quad
    ...
    \begin{enumerate}
    	...
    	\item Schreiben Sie eine Decorator, welches das \pp{Contex-Protocol} implementiert, sodass Sie mit z.B. \pp{with lock.write} das \pp{Lock} im Schreib-Modus allokieren können.
    	
    	\item[] Hinweis: Dieser Schritt kann ein wenig tricky sein, da Sie unter Umständen eine Hilfklasse benötigen, welche die eigentlichen \pp{\_\_enter\_\_()} und \pp{\_\_exit()\_\_} Funktionen implementiert.\\
